...
class WordListAdapter :
    ListAdapter<Word, TypedViewHolder<RecyclerviewItemBinding>>(object : DiffUtil.ItemCallback<Word>() {
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): TypedViewHolder<RecyclerviewItemBinding> =
        TypedViewHolder(LayoutInflater.from(parent.context).inflate(R.layout.recyclerview_item, parent, false))
